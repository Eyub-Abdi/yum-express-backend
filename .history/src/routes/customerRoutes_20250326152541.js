...
const { registerCustomer, getCustomerById, getCustomers, updateCustomer, updatePassword, deleteCustomer, verifyCustomerEmail } = require('../controllers/customerController')
