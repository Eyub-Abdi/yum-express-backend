...
const { registerAdmin, verifyAdminEmail, getAllAdmins, getAdminById, getAdminProfile, updateAdmin, deleteAdmin, updateAdminPassword, updateAdminName, updateAdminEmail } = require('../controllers/adminController')
