...
const { registerAdmin, verifyAdminEmail, getAllAdmins, getAdminById, getAdminProfile, updateAdmin, deleteAdmin, updateAdminPassword } = require('../controllers/adminController')
