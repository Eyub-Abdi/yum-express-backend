...
const { registerAdmin, verifyAdminEmail, getAllAdmins, getAdminById, getAdminProfile, updateAdmin, deleteAdmin, updateAdminPassword, updateAdminName, updateAdminEmail, updateAdminPhone, toggleAdminStatus } = require('../controllers/adminController')
...
router.get('/', authenticateUser, requireAdminRole('admin'), getAllAdmins)
...
router.patch('/:id/toggle-status', authenticateUser, requireAdminRole('superadmin'), toggleAdminStatus)
