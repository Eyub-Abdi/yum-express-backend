...
const { adminRegistrationSchema, updateAdminSchema, nameSchema, adminEmailUpdateSchema } = require('../schemas/adminSchema')
...
const registerAdmin = async (req, res) => {
  ...
  await sendEmail({ recipientEmail: email, firstName: first_name, type: 'verification', payload: { token: verificationToken, entityType: 'admins' } })
...
const updateAdminEmail = async (req, res) => {
  ...
  const { error } = adminEmailUpdateSchema.validate({ new_email: email })
  if (error) {
...
module.exports = { registerAdmin, getAllAdmins, getAdminById, getAdminProfile, updateAdmin, deleteAdmin, updateAdminPassword, verifyAdminEmail, updateAdminName, updateAdminEmail }
