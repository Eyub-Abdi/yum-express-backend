...
const { customerRegistrationSchema, customerUpdateSchema, passwordUpdateSchema, customerNameSchema } = require('../schemas/customerSchema')
...
const updateCustomerName = async (req, res) => {
  ...
  res.json({ message: 'Name updated successfully', customer: { id, first_name, last_name } })
}
